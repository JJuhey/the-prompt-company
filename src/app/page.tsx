...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col justify-between p-24 max-md:p-10">
      <div className="h-96 flex flex-col gap-5">
        <h1 className="text-4xl font-bold">Meet Prompt</h1>
        <div className="text-zinc-700 dark:text-zinc-300 text-lg max-md:text-sm">'프롬프트 엔지니어링'은 AI에게 우리가 원하는 대답을 얻기 위해 필요한 기술입니다.<br/>
